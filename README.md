...
Изменение кота(кошки) /PUT http://127.0.0.1:3000/cats/N    {"kind": {"id": N(породы)}}
Породы кошек выведены в отдельную сущность: /GET http://127.0.0.1:3000/kinds
Список неарендованных котов(кошек) /GET http://127.0.0.1:3000/cats?rent=false
Список арендованных кошек /GET http://127.0.0.1:3000/cats?rent=true
